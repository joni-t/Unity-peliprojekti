...
public class AdmobVNTIS_Interstitial : MonoBehaviour {
	...
	void Update(){
		...
		} else if(MenuFactory.MenuFactory.Instance.Kokoruudun_Mainos_Voidaan_Nayttaa) {
			MenuFactory.MenuFactory.Instance.Kokoruudun_Mainos_Voidaan_Nayttaa=false;
			if(MenuFactory.MenuFactory.Instance.Kokoruudun_Mainos_Voidaan_Nayttaa_Viivastetysti) {
				showInterstitial();
				MenuFactory.MenuFactory.Instance.Kokoruudun_Mainos_Voidaan_Nayttaa_Viivastetysti=false;
			}
			else
				showInterstitialImmediately();
			prepareInterstitial();
		}
	}
}
